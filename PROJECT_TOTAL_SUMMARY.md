...
현재 프로젝트는 Android native 앱과 Vite + React 관제 웹을 포함한 FastAPI 통합 서버로 구성되어 있다.

현재 폴더 구조
khs_project_blindNav/
└─ project/
   ├─ app/
   ├─ backend/
   │  ├─ app.py
...
project/backend/data/tactile_blocks_hwagok.geojson 파일을 읽어서 관제 웹과 앱 API에 반환
4. 현재 핵심 로직
...
project/app/
├─ app/
│  ├─ src/main/java/com/aeye/nativeapp/
│  └─ src/main/assets/
└─ README.md
